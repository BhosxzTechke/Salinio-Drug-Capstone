                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            <tr id="order-row-{{ $data->id }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-sm btn-info mark-complete-delivered" data-id="{{ $data->id }}">Complete Delivered</button>
...
'X-CSRF-TOKEN': '{{ csrf_token() }}'
        ...
        $('.mark-complete-delivered').click(function() {
            let id = $(this).data('id');

            Swal.fire({
                title: 'Mark as Complete Delivered?',
                text: 'Are you sure you want to mark this as Confirm Delivered?',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    $.post("{{ route('orders.complete.delivered') }}", { id: id }, function(data) {
                        if (data.success) {
