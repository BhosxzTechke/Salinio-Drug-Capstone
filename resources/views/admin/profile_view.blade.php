                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="text-start mt-3">
                                            ...
                                            <p class="text-muted mb-2 font-13"><strong>Name :</strong> <span class="ms-2">{{ $profileData->name }}</span></p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="email" class="form-control" id="lastname" placeholder="Enter last name">
                                                                      @error('email')
                                                                          <span class="text-danger">{{ $message }}</span>
                                                                      @enderror
                                                              </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" name="phone" class="form-control" id="lastname" placeholder="Enter last name">
                                                                      @error('number')
                                                                          <span class="text-danger">{{ $message }}</span>
                                                                      @enderror
                                                            </div>
