...
<form method="POST" id="ProvincesForm" action="{{ route('provinces.update', $province->id) }}" enctype="multipart/form-data">
    @csrf
        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    >
                            <option value="1" {{ old('is_active', $province->is_active ?? '') == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old('is_active', $province->is_active ?? '') == 0 ? 'selected' : '' }}>Inactive</option>
