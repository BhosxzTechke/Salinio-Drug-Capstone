            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input 
                        ...
                        name="shipping_fee" 
                        id="shipping_fee" 
                        value="{{ old('shipping_fee', $city->shipping_fee) }}"
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input 
                        ...
                        name="delivery_days" 
                        id="delivery_days" 
                        value="{{ old('delivery_days', $city->delivery_days) }}"
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    <label for="is_active">Status <span class="text-danger">*</span></label>
                            ...
                            >
                                <option value="1" {{ old('is_active', $city->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $city->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                    @error('is_active')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
